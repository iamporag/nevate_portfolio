...
class HotelModel extends IdentifierModel {
  ...
  HotelModel(super.id, this.ownerName, this.phoneNumber, this.email,
      this.hotelName, this.cityName, this.image);
  ...
  static HotelModel fromJSON(Map<String, dynamic> json) {
    ...
    return HotelModel(decoder.getId, ownerName, phoneNumber, email, hotelName,
        cityName, image);
  }
