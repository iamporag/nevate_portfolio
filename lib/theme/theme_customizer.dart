...
import 'dart:convert';
import 'dart:js_interop' as NavigationService;
...
class ThemeCustomizer {
  ...
  static void _notify() {
    ...
    var ctx = NavigationService.globalContext;
    if (ctx is BuildContext) {
      Provider.of<AppNotifier>(ctx as BuildContext, listen: false)
