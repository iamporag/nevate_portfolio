...
class AppTheme {
  ...
  static Color primaryColor = Color(0xff65558f);
...
class AppStyle {
  ...
  static void initMyStyle() {
    ...
    MyTextStyle.changeFontFamily('Goodly');
    My.changeTheme(AppTheme.theme);
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'TourMate', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
