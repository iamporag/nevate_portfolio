...
class LeftBarTheme {
  ...
  LeftBarTheme({
    ...
    this.activeItemColor = const Color(0xff65558f),
    this.activeItemBackground = const Color(0x4c65558f),
  });
  ...
  static final LeftBarTheme darkLeftBarTheme = LeftBarTheme(
      ...
      activeItemBackground: const Color(0x4cd0bcfe),
      activeItemColor: const Color(0xffd0bcfe));
...
class ContentTheme {
  ...
  ContentTheme({
    this.primary = const Color(0xff65558f),
